...
5. [Expose Argo CD UI (Project Access Setup)](#5-expose-argo-cd-ui-project-access-setup)
...
> **Note:** Helm is optional for this project because Argo CD is installed using Kubernetes manifests.
...
> **Note:** Context names may include the full EKS ARN depending on your `kubeconfig`. Use the context name returned by your environment throughout the project.
...
## 5. Expose Argo CD UI (Project Access Setup)

### Objective

Expose the **Argo CD UI** from the Hub Cluster so it can be accessed from a browser for project and learning purposes.
...
> ⚠️ This approach is strictly for project environments. Production systems should use an Ingress Controller with AWS ALB + HTTPS.
...
Access the **Argo CD UI** and CLI by retrieving the **initial admin credentials**, completing authentication, and understanding basic security implications in a project environment.
...
* You understand basic security limitations of project setup
...
Safely delete all AWS resources created in this project to:
...
> ⚠️ Important: Always perform cleanup after completing the project unless you explicitly want to keep resources running.
...
* Project lifecycle is completed end-to-end
...
This section connects your project implementation to **enterprise-scale DevOps and Platform Engineering use cases**.
